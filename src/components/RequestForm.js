...
import { Button2,Button6, ChoiceControl } from '../components'
  ...
  const handleOnClickRequestData = (event) => {
    ...
    if (event.target.innerText.toLowerCase() === 'next') {
      if (requestTypeValue === null) {
        errorHtml += '<p>Please choose Route Request Type</p>'
      }
      if (requestDataValue === null) {
        errorHtml += '<p>Please choose Route Request Data Type</p>'
      }
      if (errorHtml !== '') {
    ...
    <Wrapper>
      ...
      <div className="panel">
        <div id="editPanel" className="edit-panel">
          ...
          <ul className="panel-requesttype fs18">
            <li>
              <input type="radio" id="simple" name="request-type" />
              <label htmlFor="simple">Simple Route Optimization</label>
            </li>
            <li>
              <input type="radio" id="priority" name="request-type" />
              <label htmlFor="priority">Optimization With Priority</label>
            </li>
            <li>
              <input type="radio" id="vehicle" name="request-type" />
              <label htmlFor="vehicle">Optimization Vehicle Allocation</label>
            </li>
          </ul>
          <p className="subheading">Select type of data</p>
          <ul className="panel-requestdata fs18">
            <li>
              <input type="radio" id="with_latlong" name="request-datatype" />
              <label htmlFor="with_latlong">Data contains latitude-longitude</label>
            </li>
            <li>
              <input type="radio" id="without_latlong" name="request-datatype" />
              <label htmlFor="without_latlong">Data do not contain latitude-longitude, but have address
                detail</label>
            </li>
            <li>
              <input type="radio" id="with_latlong_address" name="request-datatype" />
              <label htmlFor="with_latlong_address">Data contains both latitude-longitude and address detail</label>
            </li>
          </ul>
        </div>
        <br/>
